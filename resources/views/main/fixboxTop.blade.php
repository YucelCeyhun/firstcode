<div class="box-white p-4 m-3 mb-0 w-full" id="social-media">
    ...
    <div class="mt-5">
        ...
        <div class="icon-youtube inline-block" style="width:42px;height: 42px;overflow: hidden">
            <div class="icon-wrapper" style="width: 42px;">
                <a href="#" title="Firstcode Youtube">
...
<div class="box-white p-4 m-3 mb-0 w-full flex items-center" id="search">
    <form action="{{route('main.lessons',['search' => request()->get('search')])}}" method="get" class="w-full" autocomplete="off">
