<div class="box-white p-4 m-3 mb-0 w-full" id="last-contents">
    ...
    <div class="mt-5">
                <span class="icon-discord inline-block" style="width:42px;height: 42px;overflow: hidden">
                    <div class="icon-wrapper" style="width: 42px;">
                        <a href="#" title="Firstcode Discord">
...
<div class="box-white p-4 m-3 mb-0 w-full flex justify-end items-center" id="last-commits">
